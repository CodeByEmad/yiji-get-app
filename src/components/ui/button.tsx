  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ios: "bg-app-ios text-white hover:bg-app-ios/90 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5",
        android: "bg-app-android text-white hover:bg-app-android/90 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5",
        download: "bg-gradient-primary text-white hover:shadow-glow transform hover:-translate-y-1 hover:scale-105",
      },
      size: {
